...
namespace Wst.Tools.PosiBridge.Application.IntegrationTest.Position.Bulk.GetByAccounts;

[Collection("IntegrationTests")]
public class ServiceTests(IntegrationTestsFixture fixture)
{
    private readonly PositionGetByAccounts.Service _service = fixture.GetRequiredService<PositionGetByAccounts.Service>();
    ...
    [Fact]
    public async Task GetByAccountAsync_ReturnsPositionsFromBulkStore()
    {
        ...
        var actual = await _service.GetByAccountAsync(new PositionGetByAccounts.Command([position1.Account, position2.Account]));
    ...
    [Fact]
    public async Task GetByAccountAsync_AccountsDoNotExist()
    {
        var position1 = NewPosition();
        var position2 = NewPosition();
