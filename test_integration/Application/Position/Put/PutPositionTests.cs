...
namespace Wst.Tools.PosiBridge.Application.IntegrationTest.Position.Put;

[Collection("IntegrationTests")]
public class PutPositionTests(IntegrationTestsFixture fixture)
{
    ...
    public async Task Put_ExistingPosition_Updates()
    {
        ...
        var updated = initial with
        {
            ...
            ReferencePrice = new Domain.Position.ReferencePrice.ReferencePrice(NewDecimal(), "USD", "NYSE", NewDecimal())
        };
