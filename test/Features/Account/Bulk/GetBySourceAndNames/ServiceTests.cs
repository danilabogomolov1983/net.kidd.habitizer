...
namespace Net.Kidd.Habitizer.Features.Test.Account.Bulk.GetBySourceAndNames;

public class ServiceTests(InMemoryFixture fixture) : IClassFixture<InMemoryFixture>
{
    private readonly AccountGetBySourceAndNames.Service _service = new(new Features.Source.Get.Service(new Persistence.Source.PersistenceStore(fixture.ContextFactory)), new BulkStore(fixture.ContextFactory));
